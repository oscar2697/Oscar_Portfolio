...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_oxtdj78', 'template_iazeji8',
      {
        from_name: form.name,
        to_name: 'Oscar',
  ...
  return (
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      ...
      <motion.div variants={slideIn('right', 'tween', 0.2, 1)} className='xl:flex-1 cl:h-auto md:h-[550px] h-[350px] '>
        <EarthCanvas/>
      </motion.div>
    </div>
  )
